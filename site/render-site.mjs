...
@media(max-width:950px){.desktop-nav{display:none}.mobile-nav{display:block;position:relative;border:0}.mobile-nav summary{min-width:72px;min-height:44px;padding:0 14px;display:flex;align-items:center;justify-content:center;border:1px solid var(--line);border-radius:9px;background:#fff;font-size:12px;font-weight:750}.mobile-menu{position:absolute;right:0;top:50px;width:280px;max-height:calc(100vh - 130px);overflow:auto;padding:10px;display:grid;border:1px solid var(--line);border-radius:13px;background:#fff;box-shadow:0 20px 50px rgba(31,36,49,.18)}.mobile-menu a{padding:11px 12px;border-radius:8px;font-size:11px}.mobile-menu a:hover,.mobile-menu a:focus-visible{outline:0;background:#f4f3ef}.home-hero,.page-hero-grid,.split{grid-template-columns:1fr}.hero-copy{max-width:650px}.dashboard-wrap{width:min(100%,780px);margin:auto}.section-head{grid-template-columns:1fr;gap:24px}.steps{grid-template-columns:1fr 1fr}.step:nth-child(2){border-right:0}.step:nth-child(3),.step:nth-child(4){border-top:1px solid #354052}.faq-layout{grid-template-columns:1fr}.footer-main{grid-template-columns:1fr 1fr}}
@media(max-width:700px){
  ...
  .header-row{height:64px}.logo img{width:126px}.nav-actions{gap:8px}.nav-actions>a:first-child,.nav-actions>.btn{display:none}.mobile-nav summary{min-width:66px;min-height:42px;padding:0 12px}.mobile-menu{position:fixed;left:20px;right:20px;top:104px;width:auto}
  ...
  .footer{padding:46px 0 24px}.footer-main{grid-template-columns:1fr 1fr;gap:32px 22px;padding-bottom:38px}.footer-brand{grid-column:1/-1}.footer-brand p{max-width:320px;margin-top:16px;font-size:10px}.footer-main nav:last-child{grid-column:1/-1;display:grid;grid-template-columns:1fr 1fr;column-gap:22px}.footer-main nav:last-child h4{grid-column:1/-1}.footer h4{margin:0 0 14px}.footer nav a{margin:9px 0;font-size:10px}.footer-bottom{gap:8px;flex-direction:column;line-height:1.5}
...
@media(max-width:390px){.wrap{width:calc(100% - 32px)}.announcement{padding-inline:12px}.logo img{width:118px}.mobile-menu{left:16px;right:16px}.home-hero{padding-top:42px}.hero-copy h1{font-size:40px}.section{padding:56px 0}.section-head h2,.split-copy h2{font-size:34px}.page-hero h1{font-size:40px}.bento-card,.bento-card.large{padding:23px 19px}.footer-main{column-gap:16px}}
