...
@media(max-width:950px){body:has(.mobile-nav[open]){overflow:hidden}.desktop-nav{display:none}.mobile-nav{display:block;position:relative;border:0}.mobile-nav summary{width:48px;height:48px;padding:0;display:flex;align-items:center;justify-content:center;border:1px solid var(--ink);border-radius:0;background:transparent;color:var(--ink)}.mobile-nav[open] .menu-icon i:first-child{transform:translateY(7px) rotate(45deg)}.mobile-nav[open] .menu-icon i:nth-child(2){opacity:0}.mobile-nav[open] .menu-icon i:last-child{transform:translateY(-7px) rotate(-45deg)}.mobile-menu{position:fixed;z-index:60;inset:114px 0 0;width:auto;max-height:none;overflow:auto;padding:12px 28px 28px;display:block;counter-reset:mobile-nav;border:0;border-radius:0;color:#fff;background:#0d1522;box-shadow:none}.mobile-menu>a{min-height:76px;padding:0;display:grid;grid-template-columns:42px 1fr;align-items:center;border-bottom:1px solid #3a4657;border-radius:0;color:#fff;font-size:27px;font-weight:750;letter-spacing:-.04em}.mobile-menu>a:before{counter-increment:mobile-nav;content:counter(mobile-nav,decimal-leading-zero);color:#8c85ff;font-size:9px;font-weight:800;letter-spacing:.08em}.mobile-menu>a:hover,.mobile-menu>a:focus-visible{outline:0;color:#b9b5ff;background:transparent}.mobile-menu-actions{padding-top:26px;display:grid;grid-template-columns:1fr 1fr;gap:10px}.mobile-menu-actions a{min-height:50px;display:flex;align-items:center;justify-content:center;border:1px solid #526074;color:#fff;font-size:11px;font-weight:750}.mobile-menu-actions a:last-child{border-color:var(--violet);background:var(--violet)}.home-hero,.page-hero-grid,.split{grid-template-columns:1fr}.hero-copy{max-width:650px}.dashboard-wrap{width:min(100%,780px);margin:auto}.section-head{grid-template-columns:1fr;gap:24px}.steps{grid-template-columns:1fr 1fr}.step:nth-child(2){border-right:0}.step:nth-child(3),.step:nth-child(4){border-top:1px solid #354052}.faq-layout{grid-template-columns:1fr}.footer-main{grid-template-columns:1fr 1fr}}
