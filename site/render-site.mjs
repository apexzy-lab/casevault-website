...
.header{position:relative;z-index:30;background:rgba(248,247,243,.94);backdrop-filter:blur(15px);border-bottom:1px solid rgba(18,22,31,.11)}.header-row{height:78px;display:flex;align-items:center;justify-content:space-between}.logo{display:inline-flex;align-items:center;gap:10px;font-size:19px;font-weight:800;letter-spacing:-.045em}.logo-mark{width:29px;height:29px;position:relative;display:block;border-radius:8px;background:var(--violet);transform:rotate(3deg)}.logo-mark:before,.logo-mark:after{content:"";position:absolute;top:7px;bottom:7px;width:8px;border:1.6px solid #fff}.logo-mark:before{left:7px;border-right:0;border-radius:2px 0 0 2px}.logo-mark:after{right:7px;border-left:0;border-radius:0 2px 2px 0}
.desktop-nav,.nav-actions{display:flex;align-items:center;gap:28px}.desktop-nav>a,.nav-actions>a:first-child{color:#515865;font-size:12px;font-weight:650}.desktop-nav>a:hover,.nav-actions>a:first-child:hover{color:var(--violet)}.nav-group{position:relative}.nav-group>button{padding:20px 0;border:0;color:#515865;background:transparent;font-size:12px;font-weight:650;cursor:pointer}.nav-menu{position:absolute;width:270px;left:-24px;top:53px;padding:12px;display:none;border:1px solid var(--line);border-radius:11px;background:#fff;box-shadow:0 20px 45px rgba(31,36,49,.14)}.nav-group:hover .nav-menu,.nav-group:focus-within .nav-menu{display:grid}.nav-menu a{padding:11px;border-radius:7px}.nav-menu a:hover{background:#f5f4f0}.nav-menu b,.nav-menu small{display:block}.nav-menu b{font-size:11px}.nav-menu small{margin-top:4px;color:#8a909a;font-size:8px;line-height:1.4}
...
function logo() {
  return `<a class="logo" href="/" aria-label="Casevault home"><span class="logo-mark" aria-hidden="true"></span><span>casevault</span></a>`;
}
...
function header() {
  ...
  <header class="header"><div class="header-row wrap">
    ...
    <nav class="desktop-nav" aria-label="Primary navigation">
      <div class="nav-group"><button type="button">Platform⌄</button><div class="nav-menu">
      ...
      <div class="nav-group"><button type="button">Solutions⌄</button><div class="nav-menu">
  ...
  const schemas = [
    {
      ...
      name:"Casevault",legalName:"Rova Media Digital, Inc.",url:DOMAIN,email:"sales@casvault.com",logo:`${DOMAIN}/assets/casevault-social.png`,
