...
.footer{padding:70px 0 25px;background:#fff}.footer-main{display:grid;grid-template-columns:1.4fr repeat(3,.7fr);gap:45px;padding-bottom:55px}.footer-brand p{max-width:300px;margin-top:22px;color:#858c96;font-size:10px;line-height:1.7}.footer-socials{display:flex;align-items:center;gap:9px;margin-top:20px}.footer-socials a{width:32px;height:32px;display:grid;place-items:center;border:1px solid #dfe2e6;border-radius:50%;color:var(--ink);font-size:12px;font-weight:800;line-height:1;transition:border-color .18s ease,color .18s ease,transform .18s ease}.footer-socials a:first-child span{font-size:11px;letter-spacing:-.06em}.footer-socials a:hover,.footer-socials a:focus-visible{border-color:var(--violet);color:var(--violet);transform:translateY(-2px);outline:0}.desktop-footer-links{grid-column:2/-1;display:grid;grid-template-columns:repeat(3,1fr);gap:45px}.footer-group{display:none;border:0}.footer h4{margin:4px 0 20px;font-size:9px;text-transform:uppercase;letter-spacing:.1em}.footer nav a{display:block;margin:12px 0;color:#6e7580;font-size:10px}.footer-bottom{padding-top:20px;display:flex;justify-content:space-between;border-top:1px solid #e4e6e8;color:#9298a1;font-size:8px}
...
@media(max-width:950px){body:has(.mobile-nav[open]){overflow:hidden}.header:has(.mobile-nav[open]){backdrop-filter:none}.desktop-nav{display:none}.mobile-nav{display:block;position:relative;border:0}.mobile-nav summary{width:48px;height:48px;padding:0;display:flex;align-items:center;justify-content:center;border:1px solid var(--ink);border-radius:0;background:transparent;color:var(--ink)}.mobile-nav[open] .menu-icon{align-items:center;justify-content:center}.mobile-nav[open] .menu-icon i{display:none}.mobile-nav[open] .menu-icon:before{content:"×";font-size:34px;font-weight:300;line-height:1}.mobile-menu{position:fixed;z-index:60;inset:114px 0 0;width:auto;max-height:none;overflow:auto;padding:12px 28px 28px;display:block;counter-reset:mobile-nav;border:0;border-radius:0;color:#fff;background:#0d1522;box-shadow:none}.mobile-menu>a{min-height:76px;padding:0;display:grid;grid-template-columns:42px 1fr;align-items:center;border-bottom:1px solid #3a4657;border-radius:0;color:#fff;font-size:27px;font-weight:750;letter-spacing:-.04em}.mobile-menu>a:before{counter-increment:mobile-nav;content:counter(mobile-nav,decimal-leading-zero);color:#8c85ff;font-size:9px;font-weight:800;letter-spacing:.08em}.mobile-menu>a:hover,.mobile-menu>a:focus-visible{outline:0;color:#b9b5ff;background:transparent}.mobile-menu-actions{padding-top:26px;display:grid;grid-template-columns:1fr 1fr;gap:10px}.mobile-menu-actions a{min-height:50px;display:flex;align-items:center;justify-content:center;border:1px solid #526074;color:#fff;font-size:11px;font-weight:750}.mobile-menu-actions a:last-child{border-color:var(--violet);background:var(--violet)}.home-hero,.page-hero-grid,.split{grid-template-columns:1fr}.hero-copy{max-width:650px}.dashboard-wrap{width:min(100%,780px);margin:auto}.section-head{grid-template-columns:1fr;gap:24px}.steps{grid-template-columns:1fr 1fr}.step:nth-child(2){border-right:0}.step:nth-child(3),.step:nth-child(4){border-top:1px solid #354052}.faq-layout{grid-template-columns:1fr}.footer-main{grid-template-columns:1fr 1fr}.desktop-footer-links{grid-column:1/-1}}
@media(max-width:700px){
  .wrap{width:min(100% - 40px,620px)}
  .announcement{min-height:32px;padding:7px 20px;gap:8px;font-size:9px}.announcement b{font-size:7px}.announcement a{display:none}
  .header-row{height:64px}.logo img{width:126px}.nav-actions{gap:8px}.nav-actions>a:first-child,.nav-actions>.btn{display:none}.mobile-nav summary{width:46px;height:46px}.mobile-menu{inset:96px 0 0;padding:10px 20px 24px}.mobile-menu>a{min-height:72px;grid-template-columns:38px 1fr;font-size:25px}
  .home-hero{min-height:auto;padding:48px 0 54px;gap:38px}.hero-copy h1{margin:18px 0;font-size:clamp(42px,13vw,50px);line-height:.96;letter-spacing:-.065em}.hero-copy>p{font-size:15px;line-height:1.6}.hero-actions{margin-top:25px;align-items:stretch;flex-direction:column;gap:16px}.hero-actions .btn{width:100%}.text-link{padding:4px 0}.proof-note{margin-top:26px;gap:10px;line-height:1.45}
  .dashboard-wrap{height:auto;overflow:visible}.dashboard{width:100%;min-height:0;grid-template-columns:72px minmax(0,1fr);border-radius:12px;transform:none;box-shadow:0 20px 45px rgba(31,36,49,.13)}.dash-side{padding:14px 7px}.dash-brand{margin-bottom:16px;font-size:7px}.dash-item{padding:7px 5px;font-size:5px}.dash-item b{display:none}.dash-main{min-width:0;padding:14px 12px}.dash-head h3{font-size:13px}.avatar{width:24px;height:24px}.metrics{margin:14px 0 10px;grid-template-columns:1fr 1fr;gap:6px}.metric{min-width:0;padding:9px}.metric:nth-child(3){display:none}.metric strong{margin:5px 0 2px;font-size:16px}.dash-grid{display:block}.deadline-list{display:none}.case-line{min-height:42px;padding:6px 8px}.case-person{min-width:0;gap:6px}.case-person i{width:22px;height:22px;flex:0 0 22px;font-size:5px}.case-person span{min-width:0}.case-person b,.case-person small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.case-person b{font-size:6px}.status{padding:3px 5px;font-size:5px}.float-note{display:none}
  .trust .wrap{padding:20px 0;grid-template-columns:repeat(3,1fr);align-items:stretch}.trust p{grid-column:1/-1;margin:0 0 16px;font-size:10px;line-height:1.55}.trust-stat{padding:14px 10px;border-top:1px solid var(--line)}.trust-stat:first-of-type{border-left:0}.trust-stat strong{font-size:18px}.trust-stat span{font-size:6px}
  .section{padding:64px 0}.section-head{gap:16px;margin-bottom:30px}.section-head h2,.split-copy h2{font-size:clamp(35px,10.5vw,42px);line-height:1.02}.section-head>p,.split-copy>p{font-size:13px;line-height:1.65}
  .card-grid,.pricing-grid,.contact-grid,.bento{grid-template-columns:1fr}.card-grid,.pricing-grid,.contact-grid{gap:12px}.card{min-height:0;padding:24px}.card h3{margin:25px 0 9px}.card p{font-size:11px}
  .bento{gap:12px}.bento-card,.bento-card.large{min-height:0;padding:26px 22px;grid-column:auto;grid-template-columns:1fr;gap:24px}.bento-card h3{margin:15px 0 10px;font-size:27px}.bento-card p{font-size:11px}.pipeline{padding:18px}.pipe-head{margin-bottom:14px}.pipe-row{margin:11px 0;grid-template-columns:62px 1fr 14px;gap:8px}
  .steps{grid-template-columns:1fr}.step,.step:not(:first-child){min-height:0;padding:22px 0;display:grid;grid-template-columns:50px 1fr;column-gap:16px;border-right:0;border-top:0;border-bottom:1px solid #354052}.step:last-child{border-bottom:0}.step>span{grid-column:1;align-self:center}.step i{grid-column:1;grid-row:2/4;width:42px;height:42px;margin:18px 0 0}.step h3{grid-column:2;margin:18px 0 7px;font-size:17px}.step p{grid-column:2;font-size:10px}
  .page-hero{padding:46px 0 56px}.breadcrumbs{margin-bottom:24px}.page-hero-grid{gap:34px}.page-hero h1{margin:16px 0 18px;font-size:clamp(42px,12vw,50px);line-height:.98}.page-hero p{font-size:14px;line-height:1.65}.hero-panel{min-height:auto;padding:20px}.hero-panel h3{font-size:17px}.check-list li{font-size:10px}
  .split{gap:34px}.visual-card{min-height:0;padding:20px}.visual-row{min-height:56px}.pricing-grid{gap:14px}.price-card{padding:24px}.price-card.featured{transform:none}.price-card p{min-height:0}.pricing-toggle{max-width:100%}.pricing-toggle button{padding:9px 11px}.faq-layout{gap:28px}.faq-layout h2{font-size:38px}
  .cta{padding:72px 20px}.cta:before{width:480px;height:480px}.cta:after{width:680px;height:300px}.cta h2{font-size:clamp(39px,11vw,48px);line-height:1.02}.cta p{font-size:12px;line-height:1.55}.cta .btn{min-width:190px}
  .footer{padding:50px 0 26px;color:#fff;background:#0b121c}.footer-main{display:block;padding-bottom:36px}.footer-brand{padding-bottom:30px;border-bottom:1px solid #3a4657}.footer .logo img{filter:brightness(0) invert(1)}.footer-brand p{max-width:320px;margin-top:18px;color:#9ba8b8;font-size:11px;line-height:1.7}.footer-socials{margin-top:18px}.footer-socials a{border-color:#3a4657;color:#fff}.desktop-footer-links{display:none}.footer-group{display:block;border-bottom:1px solid #3a4657}.footer-group>summary{padding:22px 0;display:flex;color:#8c85ff;font-size:10px;font-weight:800;letter-spacing:.12em;text-transform:uppercase}.footer-group>summary span{color:#fff;font-size:22px;line-height:1;transition:transform .18s ease}.footer-group>nav{display:none!important;padding:0 0 18px}.footer-group[open]>nav{display:block!important}.footer-group nav h4{display:none}.footer nav a{margin:0;padding:8px 0;color:#aab5c3;font-size:11px}.footer-bottom{padding-top:24px;gap:9px;flex-direction:column;border-color:#3a4657;color:#8996a6;line-height:1.5}
  .comparison{display:block;overflow-x:auto}.story{padding:24px}.story p{font-size:18px}.contact-card{padding:24px}.legal-copy article{padding:22px 0}
}
@media(max-width:390px){.wrap{width:calc(100% - 32px)}.announcement{padding-inline:12px}.logo img{width:118px}.mobile-menu{padding-inline:16px}.mobile-menu>a{font-size:23px}.home-hero{padding-top:42px}.hero-copy h1{font-size:40px}.section{padding:56px 0}.section-head h2,.split-copy h2{font-size:34px}.page-hero h1{font-size:40px}.bento-card,.bento-card.large{padding:23px 19px}}
...
function header() {
  ...
  <header class="header"><div class="header-row wrap">
    ...
    <div class="nav-actions"><a href="${APP_URL}">Log in</a><a class="btn dark" href="${APP_URL}">Start free <span>↗</span></a>
      <details class="mobile-nav"><summary aria-label="Open navigation"><span class="menu-icon" aria-hidden="true"><i></i><i></i><i></i></span></summary><nav class="mobile-menu" aria-label="Mobile navigation"><a href="/features/">Platform</a><a href="/case-management/">Case management</a><a href="/document-management/">Documents</a><a href="/client-portal/">Client portal</a><a href="/pricing/">Pricing</a><a href="/security/">Security</a><a href="/about/">About</a><a href="/contact/">Contact</a><div class="mobile-menu-actions"><a href="${APP_URL}">Log in</a><a href="${APP_URL}">Start free →</a></div></nav></details>
    </div>
  </div></header>`;
}
...
function footer() {
  return `<footer class="footer"><div class="wrap"><div class="footer-main">
    <div class="footer-brand">${logo()}<p>Immigration case management, without the chaos.</p><div class="footer-socials" aria-label="Casevault social media"><a href="https://www.linkedin.com/company/casevault" target="_blank" rel="noopener noreferrer" aria-label="Casevault on LinkedIn"><span aria-hidden="true">in</span></a><a href="https://x.com/casevaultc" target="_blank" rel="noopener noreferrer" aria-label="Casevault on X"><span aria-hidden="true">X</span></a></div></div>
    ...
    <details class="footer-group"><summary>Product<span>+</span></summary><nav aria-label="Product links"><h4>Product</h4><a href="/features/">Features</a><a href="/case-management/">Case management</a><a href="/document-management/">Documents</a><a href="/client-portal/">Client portal</a><a href="/pricing/">Pricing</a></nav></details>
    <details class="footer-group"><summary>Solutions<span>+</span></summary><nav aria-label="Solution links"><h4>Solutions</h4><a href="/solutions/solo-consultants/">Solo consultants</a><a href="/solutions/immigration-law-firms/">Law firms</a><a href="/solutions/multi-country-practices/">Multi-country practices</a><a href="/how-it-works/">How it works</a></nav></details>
    <details class="footer-group"><summary>Company<span>+</span></summary><nav aria-label="Company links"><h4>Company</h4><a href="/about/">About</a><a href="/security/">Security</a><a href="/faq/">FAQ</a><a href="/demo/">Book a demo</a><a href="/contact/">Contact</a><a href="/legal/">Legal</a><a href="${SUPPORT_URL}">Support ↗</a></nav></details>
...
function pricingPage() {
  ...
  <section class="section"><div class="wrap" data-pricing><div class="pricing-toggle" role="group" aria-label="Billing period"><button class="active" type="button" data-period="monthly" aria-pressed="true">Monthly pricing</button><button type="button" data-period="annual" aria-pressed="false">Annual · Save 20%</button></div><div class="pricing-grid">
    <article class="price-card"><span>Starter</span><h3>Solo practice</h3><div class="amount"><span class="price-value" data-monthly="$39" data-annual="$384">$39</span><small class="price-suffix">/month</small></div><p>For independent consultants managing their own caseload.</p><a class="btn ghost" href="${APP_URL}">Start with Starter ↗</a><ul class="check-list"><li><i>✓</i>Up to 25 active cases</li><li><i>✓</i>1 user</li><li><i>✓</i>Client and case management</li><li><i>✓</i>Documents and invoicing</li></ul></article>
    <article class="price-card featured"><span>Pro</span><b class="badge">Most popular</b><h3>Growing practice</h3><div class="amount"><span class="price-value" data-monthly="$89" data-annual="$888">$89</span><small class="price-suffix">/month</small></div><p>For practices with multiple case handlers and a growing caseload.</p><a class="btn" href="${APP_URL}">Start with Pro ↗</a><ul class="check-list"><li><i>✓</i>Up to 3 team members</li><li><i>✓</i>Task management</li><li><i>✓</i>Shared case visibility</li><li><i>✓</i>Client portal and communication</li></ul></article>
    <article class="price-card"><span>Agency</span><h3>Established firm</h3><div class="amount"><span class="price-value" data-monthly="$179" data-annual="$1,788">$179</span><small class="price-suffix">/month</small></div><p>For established firms managing high case volume across countries.</p><a class="btn ghost" href="/demo/">Talk to us ↗</a><ul class="check-list"><li><i>✓</i>Unlimited team members</li><li><i>✓</i>High-volume case management</li><li><i>✓</i>Dedicated onboarding</li><li><i>✓</i>Built for multi-country work</li></ul></article>
...
function interactionScripts() {
  return `<script>
    document.querySelectorAll('[data-pricing]').forEach(function(pricing) {
      var controls = pricing.querySelectorAll('[data-period]');
      var prices = pricing.querySelectorAll('.price-value');
      var suffixes = pricing.querySelectorAll('.price-suffix');

      controls.forEach(function(control) {
        control.addEventListener('click', function() {
          var period = control.dataset.period;
          var isAnnual = period === 'annual';

          controls.forEach(function(option) {
            var isActive = option === control;
          ...
          suffixes.forEach(function(suffix) {
            suffix.textContent = isAnnual ? '/year' : '/month';
          });
        });
      });
    });
...
function shell(path, body) {
  ...
  </head><body>${header()}${body}${footer()}${interactionScripts()}</body></html>`;
}
